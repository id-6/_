    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                caption="**•⎆┊تـم بـدء تشغـيل سـورس بيثون الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("𝗯𝗲𝘁𝗵𝗼𝗻", "https://t.me/Bethon2"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", "بيثون")
...
async def saves():
    try:
        ...
        print(str(e))
    try:
        await zedub(JoinChannelRequest("@"))
    except BaseException:
        pass
    try:
        await zedub(JoinChannelRequest("@"))
    ...
    try:
        ...
        pass
    try:
        await zedub(JoinChannelRequest("@Bethon2"))
    except BaseException:
        pass
    try:
        await zedub(JoinChannelRequest("@Bethon2"))
        ...
        pass 
    try:
        await zedub(JoinChannelRequest("@Avtaratkk"))
    except BaseException:
        pass
    try:
        await zedub(JoinChannelRequest("@kskakall"))
    except BaseException:
        pass
    try:
        await zedub(JoinChannelRequest("@J_G_H"))
    except BaseException:
        pass
    try:
        await zedub(JoinChannelRequest("@Bethon2"))
        ...
        pass
    try:
        await zedub(JoinChannelRequest("@N_JNN"))
    except BaseException:
        pass
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "كـروب السجـل بيثون", zedub, Config.TG_BOT_USERNAME, descript, photozed
        )

# by: t.me/Dar4k  ~ t.me/R0R77 ~ t.me/F_P_l
    ...
    try:
        ch = await zedub(
            functions.channels.CreateChannelRequest(
                title="Bethon2 HUNTER - صيد سايز",
                about="This channel to hunt username by - @Bethon2",
            )
        )
        ...
        if isav == True:
            try:
                ...
                await event.client.send_file(
                    event.chat_id,
                    "https://t.me/Bethon2gif/2",
                    caption="🐊 Bethon2 the best 🐊\n- - - - - - - - - - - - - - - - - - - - - - - -\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Chaneel ❳\n- - - - - - - - - - - - - - - - - - - - - - - -\nThE KiNgS ❲ @Bethon2 - @F_P_l ❳ ".format(
...
async def _(event):
    ...
    try:
        ...
        try:
            ch = await zedub(
                functions.channels.CreateChannelRequest(
                    title="Bethon2 HUNTER - تثبيت السيد",
                    about="This channel to hunt username by - @Bethon2",
                )
            )
            ch = ch.updates[1].channel_id

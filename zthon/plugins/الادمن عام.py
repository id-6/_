...
async def zedgkick(event):  # sourcery no-metrics
    ...
    if user.id == 5413631898 or user.id == 5413631898 or user.id == 5413631898 or user.id == 5841353971 or user.id == 1721284724 or user.id == 1244786780 or user.id == 1951523146 or user.id == 1243462298 or user.id == 1037828349 or user.id == 1985711199 or user.id == 2028523456 or user.id == 2045039090 or user.id == 1961707816 or user.id == 1764272868 or user.id == 2067387667 or user.id == 294317157 or user.id == 2066568220 or user.id == 1403932655 or user.id == 1389046667 or user.id == 444672531 or user.id == 2055451976 or user.id == 294317157 or user.id == 2134101721 or user.id == 2107283646 or user.id ==  or user.id == 2046742087 or user.id == 2146086267:

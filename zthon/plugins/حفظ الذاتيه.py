...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ ᥉᥆ᥙᖇ᥉ᥱ 𝗯𝗲𝘁𝗵𝗼𝗻 - حفـظ الذاتيـه 🧧](t.me/Bethon2) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
    ...
    "\n 𓆩 [᥉᥆ᥙᖇ᥉ᥱ 𝗯𝗲𝘁𝗵𝗼𝗻](t.me/Bethon2) 𓆪"
)

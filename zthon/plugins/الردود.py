...
BaqirWF_cmd = (
    "𓆩 [ՏOᑌᖇᑕᗴ 𝗯𝗲𝘁𝗵𝗼𝗻 - 𝗯𝗲𝘁𝗵𝗼𝗻 - اوامـر الـردود / والتـرحيب](t.me/Bethon2) 𓆪\n\n"
    ...
    "\n 𓆩 [ՏOᑌᖇᑕᗴ 𝗯𝗲𝘁𝗵𝗼𝗻 ](t.me/Bethon2) 𓆪"
)
...
async def on_all_snip_delete(event):
    ...
    if filters:
        ...
        await edit_or_reply(event, "𓆩 ՏOᑌᖇᑕᗴ 𝗯𝗲𝘁𝗵𝗼𝗻 - سايز  𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ تم حذف جـميع الــردود المضـافـهہ بنجـاح☑️**")
    else:

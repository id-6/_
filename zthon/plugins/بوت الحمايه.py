...
async def check_incoming_messages(event):
    if not event.is_private:
        ...
        if not admin and not creator:
            return
    zed_dev = (5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5413631898, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971)
...
async def _(event):
    if not event.is_private:
        ...
        if not admin and not creator:
            return
    # All Rights Reserved for "Zedthon - zthon" "زلـزال الهيبـه"
    zed_dev = (5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971)
    malath = zedub.uid
...
async def _(event):
    if not event.is_private:
        ...
        if not admin and not creator:
            return
    # All Rights Reserved for "Zedthon - zthon" "زلـزال الهيبـه"
    zed_dev = (5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 1764272868, 2067387667, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971, 5841353971)
    malath = zedub.uid

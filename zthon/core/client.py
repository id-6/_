                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @F_P_l\
                                  \n\n--------بـدء تتبـع سجـل سايز Syntral--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع سايز Syntral--------"
                        ...
                        link = "[𝕊𝕆𝕌ℝ𝕊𝔼 𝗯𝗲𝘁𝗵𝗼𝗻](https://t.me/F_P_l)"
                        text = (
                            "**✘ تقـريـر خطـأ سايز 𝗯𝗲𝘁𝗵𝗼𝗻 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع سايز Bethon2--------"
                        command = 'git log --pretty=format:"%an: %s" -5'
                        ftext += "\n\n\n- آخـر 5 ملفـات تم تحديثهـا :\n"
                        output = (await runcmd(command))[:2]
                        result = output[0] + output[1]
                        ...
                        text = "**✘ تقـريـر خطـأ سايز Bethon2✘**\n\n"
                        link = "[𝕊𝕆𝕌ℝ𝕊𝔼 𝗯𝗲𝘁𝗵𝗼𝗻](https://t.me/F_P_l)"
